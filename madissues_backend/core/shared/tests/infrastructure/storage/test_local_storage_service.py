...
class TestLocalStorageService(unittest.TestCase):
    ...
    def test_upload_b64_image(self):
        ...
        with open(test_b64image_path, "rb") as file:
            ...
            path = self.storage_service.upload_b64_image(image, folder="tests", image_name="cat.jpeg")
    ...
    def test_get_b64_image(self):
        ...
        retrieved_image = self.storage_service.get_b64_image(image_name="cat.jpeg", folder="tests")
    ...
    def test_delete_image(self):
        ...
        self.storage_service.delete_image(folder="tests", image_name="cat.jpeg")
