...
class ToggleLikeIssueCommentCommand(Command[ToggleLikeCommentRequest, ToggleLikeCommentResponse]):
    ...
    def execute(self, request: ToggleLikeCommentRequest) -> Response[ToggleLikeCommentResponse]:
        ...
        if user_id in comment.likes:
            ...
            return Response.ok(ToggleLikeCommentResponse(id=str(comment.id), likes_count=len(comment.likes)))
        else:
